...
from AutoPGD.losses import difference_of_logits_ratio
...
def _apgd(model: nn.Module,
    ...
    # Added By grabriel to input a custom criterion
    if give_crit:
        criterion_indiv, multiplier = (crit, -1 if targeted else 1)
    else:
